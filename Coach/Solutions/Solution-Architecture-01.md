...
> **Part of the Coach solution** — deploy with [Solution 00](Solution-How-To-Deploy-All-00.md); run the demo with the [Demo Runbook (02)](Solution-Demo-Runbook-02.md); apply configuration with the [Config script guide (03)](Solution-How-To-Azure-SRE-Agent-Config-03.md).
...
- Full resource inventory: [azure-sre-agent-complete-resource-reference.md](docs/azure-sre-agent/azure-sre-agent-complete-resource-reference.md)
- Ownership (Terraform vs YAML+API): [resource-support-matrix.md](docs/azure-sre-agent/resource-support-matrix.md)
- Deployment commands: [Solution-How-To-Azure-SRE-Agent-Config-03.md](Solution-How-To-Azure-SRE-Agent-Config-03.md)
- IaC boundary decision: [adr/0001-sre-agent-iac-boundaries.md](docs/azure-sre-agent/adr/0001-sre-agent-iac-boundaries.md)
- Live, scenario-by-scenario demo: [Solution-Demo-Runbook-02.md](Solution-Demo-Runbook-02.md)
...
two layers (see [ADR 0001](docs/azure-sre-agent/adr/0001-sre-agent-iac-boundaries.md)):
...
2. **Sample Food / Grubify operational layer** (imported from `dm-chelupati/sre-agent-lab`;
   the Grubify app now lives in this repo, `microsoft/frontier-sre-agent-rvas`, under
   `Student/Resources/grubify/`): the `aca-app-incident-handler` (imported as
...
- Why: subscription-wide FinOps — correlates inventory and configuration (Azure Resource Graph),
  ...
  [cost-optimization-agent.md](docs/azure-sre-agent/cost-optimization-agent.md)).
...
- **`kql-catalog.md`** — How: ready KQL for Traffic Analytics. When: composing queries. Why:
  reuse vetted queries (mirrors [kql-catalog.md](docs/demo-lab/kql-catalog.md)).
...
- **`triage-grubify-issues`** — How: lists untriaged `[Customer Issue]`s in
  `microsoft/frontier-sre-agent-rvas` and triages each per the runbook. When: every 12 h. Why: the
...
Live validation evidence: [validation-evidence.md](docs/demo-lab/validation-evidence.md).
...
| Topic | Document |
| --- | --- |
| Live scenario walkthrough (6 scenarios) | [Solution-Demo-Runbook-02.md](Solution-Demo-Runbook-02.md) |
| What the lab deploys + commands | [README.md](docs/demo-lab/README.md) |
| KQL queries | [kql-catalog.md](docs/demo-lab/kql-catalog.md) |
| Resource ownership (TF vs YAML+API) | [resource-support-matrix.md](docs/azure-sre-agent/resource-support-matrix.md) |
| Full resource inventory | [azure-sre-agent-complete-resource-reference.md](docs/azure-sre-agent/azure-sre-agent-complete-resource-reference.md) |
| Deployment script guide | [Solution-How-To-Azure-SRE-Agent-Config-03.md](Solution-How-To-Azure-SRE-Agent-Config-03.md) |
| IaC boundary decision | [adr/0001-sre-agent-iac-boundaries.md](docs/azure-sre-agent/adr/0001-sre-agent-iac-boundaries.md) |
