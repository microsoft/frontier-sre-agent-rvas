...
# Challenge 14 — Resolve a Backup Assurance Incident
...
> **Customer demo script:** Run `pwsh -File '.\SRE SignalOps\Scripts\Challenge-14.ps1'` to inventory vaults and produce a review-ready Teams update. See the [presenter runbook](./Scripts/README.md).
