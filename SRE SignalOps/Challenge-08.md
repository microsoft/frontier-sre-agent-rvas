...
# Challenge 08 — Scope Impact with Dependency Evidence
...
> **Customer demo script:** Run `pwsh -File '.\SRE SignalOps\Scripts\Challenge-08.ps1'` to generate API traffic and query Application Insights. See the [presenter runbook](./Scripts/README.md).
