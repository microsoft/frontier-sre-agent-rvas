...
- Use the preserved [Lab Details baseline](./Lab-Details.md#normal-baseline) as comparison evidence; do not recreate or redefine normal during the incident.
