...
- The report intentionally runs in **read-only** mode — no write operations, no resource changes. Its only output is the narrative. This makes it safe to run frequently and to have automated without human approval.
